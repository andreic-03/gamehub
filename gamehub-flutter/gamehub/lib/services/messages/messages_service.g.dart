...
class _MessagesService implements MessagesService {
  _MessagesService(this._dio, {this.baseUrl, this.errorLogger});
  ...
  @override
  Future<List<MessageModel>> getMessagesByGamePostId(int gamePostId) async {
